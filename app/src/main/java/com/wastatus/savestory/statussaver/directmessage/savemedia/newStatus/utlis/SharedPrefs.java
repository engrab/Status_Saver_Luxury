...
public class SharedPrefs {
    ...
    public static void setAutoSave(Context context, Boolean value) {
        getInstance(context).edit().putBoolean(AUTO_SAVE, value).apply();
    }
    ...
    public static void setReadTime(Context context, int value) {
        getInstance(context).edit().putInt(TIME, value).apply();
    }

    public static int getWriteTime(Context context) {
        return getInstance(context).getInt(TIME, 15);
    }
}
